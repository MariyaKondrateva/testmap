...
var lyr__1 = new ol.layer.Image({
                            opacity: 1,
                            title: 'Сумма температур почвы >10 градусов <br><img src="legend.png" width="100px">',
...
var lyr_T_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/T_2_1.png" /> Районы по которым <br>проведено обследование <br>почв<br />'
        });
...
lyr_K_0.setVisible(true);lyr__1.setVisible(false);lyr_T_2.setVisible(false);lyr_P_3.setVisible(true);
var layersList = [lyr_K_0,lyr__1,lyr_T_2,lyr_P_3];
